...
SECRET_KEY = 'qcw%_aafo3svh5i&uin$6t2uth#d575f9ilxol6+(f19n@j32!'
...
DATABASES = {
    'default': {
        ...
        # NAME: name of the database in postgres

        'NAME': 'django_template_db_0',
        'USER': 'django_template_user_0',
        'PASSWORD': 'h@unter2@',
        'HOST': 'db',
        'PORT': '5432',
    }
...
CELERY_TASK_ROUTES = {
    'django_template_proj.user.tasks._send_mail': {'queue': 'mail', },
}
